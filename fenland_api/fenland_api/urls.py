...
urlpatterns = patterns('',
    ...
    url(r'^althtml/(\w+)/(\w+)/(\w+)', csrf_exempt(html_renderer_views.AltHTMLView.as_view())),
    url(r'^althtml/(\w+)/(\w+)', csrf_exempt(html_renderer_views.AltHTMLView.as_view())),
    url(r'^althtml/(\w+)', csrf_exempt(html_renderer_views.AltHTMLView.as_view())),
    url(r'^althtml/', csrf_exempt(html_renderer_views.AltHTMLView.as_view())),
    ...
    url(r'^alttest/(\w+)/(\w+)/(\w+)', csrf_exempt(html_renderer_views.AltTestView.as_view())),
    url(r'^alttest/(\w+)/(\w+)', csrf_exempt(html_renderer_views.AltTestView.as_view())),
    url(r'^alttest/(\w+)', csrf_exempt(html_renderer_views.AltTestView.as_view())),
    url(r'^alttest/', csrf_exempt(html_renderer_views.AltTestView.as_view())),
