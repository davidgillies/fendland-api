(function ($, undefined) {
    ...
    function getAddress4search() {
        var address = [];
        var sStreetAddress2 = $('#id_addr1').val();
        if (sStreetAddress2) {
            sStreetAddress2 = ' ' + sStreetAddress2;
        }
		console.log(sStreetAddress2)
        address.push($('#id_addr2').val() + sStreetAddress2);
        address.push($('#id_town').val());
        address.push('UK');
        address.push($('#id_postcode').val());
        return address.join(', ');
    }
